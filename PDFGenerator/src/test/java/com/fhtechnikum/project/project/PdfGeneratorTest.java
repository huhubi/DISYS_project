...
public class PdfGeneratorTest {
    ...
    public void testGeneratePdf() {
        String filePath = "../Frontend/FuelStationUI/src/main/resources/files/invoices/1.pdf";
    ...
    public void generatePdfWithNoStations() throws IOException {
        ...
        File file = new File("../Frontend/FuelStationUI/src/main/resources/files/invoices/1.pdf");
        Assertions.assertTrue(file.exists());

        String content = new String(Files.readAllBytes(Paths.get(file.getPath())));
        Assertions.assertTrue(!content.contains("Station:"));
    }
